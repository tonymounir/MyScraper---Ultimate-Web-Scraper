document.addEventListener('DOMContentLoaded', function() {
  ...
  const elements = {
    ...
    extractToPageBtn: document.getElementById('extractToPageBtn'),
  ...
  // Export data
  if (elements.extractToPageBtn) {
    elements.extractToPageBtn.addEventListener('click', () => {
      // This will open a new page with the full data table.
      chrome.tabs.create({ url: 'full_data_view.html' });
    });
  }
